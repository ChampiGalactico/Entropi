        ...
        >
          ...
          <div className="max-h-64 overflow-y-auto">
            {filtered.map((opt) => (
              ...
              className={`flex w-full items-center gap-2 rounded-xl px-3 ${compact ? "py-1.5 text-xs" : "py-2 text-sm"} text-left transition-colors duration-100 hover:bg-surface-hover ${
